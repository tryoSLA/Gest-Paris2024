...
public class Equipes
{
    ...
    private static int nbChampEquipe = 4;
    ...
    public static int getNbChampEquipe() {
        return nbChampEquipe;
    }

    public static void setNbChampEquipe(int nbChampPays) {
        Equipes.nbChampEquipe = nbChampPays;
    }
